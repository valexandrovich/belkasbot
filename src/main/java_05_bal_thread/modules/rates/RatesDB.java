...
public class RatesDB {
    ...
    public static synchronized boolean removeUserCurrency(int userID, String ccy){
        int removedRows = 0;
        try{
    ...
    public static synchronized boolean addUserCurrency(int userID, String ccy){
        int addedRows = 0;
        try {
    ...
    public static synchronized boolean addUserEmail (int userID, String email){
        int addedRows = 0;
        try {
    ...
    public static synchronized boolean removeUserEmail(int userID, String email){
        int deletedRows = 0;
        try {
    ...
    public static synchronized boolean setEmailCursor(int userID, int cursor){
        int addedRows = 0;
        try{
    ...
    public static synchronized boolean incrementEmailCursor(int userID){
    ...
    public static synchronized boolean decrementEmailCursor(int userID){
    ...
    //@Deprecated
    public static synchronized boolean addRatesResponce(int userID, java.util.Date date){
        int insertedRows = 0;
        try {
    ...
    public static java.util.Date getLastRateDate (int userID){
        java.util.Date lastRateDate = new Date(System.currentTimeMillis());
        try{
